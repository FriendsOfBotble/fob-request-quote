...
class RequestQuoteSettingRequest extends Request
{
    public function rules(): array
    {
        return [
            ...
            'request_quote_enabled_fields' => ['nullable', 'array'],
            'request_quote_enabled_fields.*' => ['nullable'],
            'request_quote_required_fields' => ['nullable', 'array'],
            'request_quote_required_fields.*' => ['nullable'],
